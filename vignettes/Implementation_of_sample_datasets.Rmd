...
if (grepl("vignettes", getwd())) {rootdir<-"."} else {rootdir<-"vignettes"}
csv_files<-list.files(rootdir, pattern = ".csv")
...
```{r, results = "hide"}
system.time(NCT <- newCorrespondenceTable("names.csv", "newCorrespondenceTableCase1.csv", "A", 0.5))
```
...
```{r, results = "hide"}
system.time(NCT <- newCorrespondenceTable("names.csv", "newCorrespondenceTableCase2.csv", "B", 0.5))
```
...
```{r, results = "hide"}
system.time(NCT <- newCorrespondenceTable("names.csv", "newCorrespondenceTableCase3.csv", "B", 0.5))
```
...
```{r, results = "hide"}
system.time(NCT <- newCorrespondenceTable("names.csv", "newCorrespondenceTableCase4.csv", "none", 0.96))
```
