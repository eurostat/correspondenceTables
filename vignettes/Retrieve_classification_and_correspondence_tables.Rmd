...
The arguments level and language are optional and set as default as level=”ALL” and language=”en”.
...
This function is created to automatically obtain a list the prefixes from CELLAR and FAO used in the retrieveClassificationTable() and retrieveCorrespondenceTable() functions to retrieve the required tables. The list will be updated automatically each time a new classification or correspondence classification is introduced in CELLAR or FAO repository.
...
The argument language is optional and set as default as language=”en”.
