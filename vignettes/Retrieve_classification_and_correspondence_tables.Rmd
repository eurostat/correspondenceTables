...
result = retrieveClassificationTable(prefix, endpoint, conceptScheme, level = level, CSVout, showQuery) 
result
...
result = retrieveCorrespondenceTable(prefix, endpoint, ID_table, language, CSVout, showQuery)
result
# identify the SPARQL query used
result[[1]]
```
