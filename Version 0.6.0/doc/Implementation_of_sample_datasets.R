...
## ---- results = "hide"--------------------------------------------------------
UPC <- updateCorrespondenceTable(A, B, AStar, AB, AAStar, "updateCorrespondenceTableCase2.csv", "A", 0.1, 0.1)
...
## ---- results = "hide"--------------------------------------------------------
UPC <- updateCorrespondenceTable(A, B, AStar, AB, AAStar, "updateCorrespondenceTableCase3.csv", "none", 0.4, 0.1)
...
## ---- results = "hide"--------------------------------------------------------
UPC <- updateCorrespondenceTable(A, B, AStar, AB, AAStar, "updateCorrespondenceTableCase4.csv", "B", 0.1, 0.1)
...
## ---- results = "hide"--------------------------------------------------------
UPC <- updateCorrespondenceTable(A, B, AStar, AB, AAStar, "updateCorrespondenceTableCase5.csv", "B", 0.1, 0.6)
...
## ---- results = "hide"--------------------------------------------------------
UPC <- updateCorrespondenceTable(A, B, AStar, AB, AAStar, "updateCorrespondenceTableCase6.csv", "B", 0.1, 0.6)
...
## ---- results = "hide"--------------------------------------------------------
NCT <- newCorrespondenceTable("names.csv", "newCorrespondenceTableCase1.csv", "A", 0.2)
...
## ---- results = "hide"--------------------------------------------------------
NCT <- newCorrespondenceTable("names.csv", "newCorrespondenceTableCase2.csv", "B", 0.3)
...
## ---- results = "hide"--------------------------------------------------------
NCT <- newCorrespondenceTable("names.csv", "newCorrespondenceTableCase4.csv", "none", 0.95)
