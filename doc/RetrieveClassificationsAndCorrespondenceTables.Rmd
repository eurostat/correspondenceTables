...
This vignette uses the option `useLocalDataForVignettes = TRUE` to ensure reproducibility. All examples are based on static data files and can be executed without requiring a network connection or SPARQL access.
