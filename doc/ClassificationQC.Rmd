...
* lengths -  The user provide a csv file the different level of hierarchical classification.    
...
**Requirement for the csv file for lengths, singleChildCode, sequencing**

**lengths** the user provide a csv file with these headers **charb chare**
...
The user provide a csv file for Classification and lengths. 
